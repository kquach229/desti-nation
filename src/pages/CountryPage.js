...
class CountryPage extends React.Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(
        `https://api.unsplash.com/search/photos?client_id=${Access_Key}&query=${this.props.match.params.name}`
      )
      .then((response) => {
        this.setState({
      ...
      >
        ...
        <div className="countryContainer">
          ...
          <div data-aos="fade-right" className="countryRegion">
            ...
            <div className="propertyName">
              Region:{" "}
              <span className="propertyValue">{this.state.country.region}</span>
            </div>
            <div className="propertyName">
              Subregion:{" "}
              <span className="propertyValue">
            ...
            <div className="propertyName">
              Area:{" "}
              <span className="propertyValue">{this.state.country.area}</span>
            </div>
          </div>
